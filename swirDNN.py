...
model.save('./DNN_SWIR.hdf5') # save DNN
np.savetxt('DNN_SWIR_norm_terms.csv', norm_terms, delimiter=',') # save normalization terms
np.savetxt('DNN_SWIR_loss.csv', loss_history, delimiter=',') # save loss history
