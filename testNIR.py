...
#%% Load model
model = keras.models.load_model('./DNN_NIR.hdf5') # load DNN 
matData_in = spio.loadmat('./R_NIR_train_MC.mat') # load training data from mat file, for normalization of testing data
...
matData_test = spio.loadmat('./R_NIR_test_MC.mat') # load testing data
eval_vec = matData_test['R_NIR'] # 'R_NIR' is matrix of test data inputs
...
#%%  Save estimates
np.savetxt('DNN_NIR_estimates.csv', p, delimiter=',')