...
add_noise = 1; % testing data will have added noise
...
N = 25000; % number of simulations to be run
...
noise = 5; % standard deviation of the zero-mean Gaussian noise
lambda0 = 980; % set reference wavelength for Power Law formula
saveName_SWIR = 'R_SWIR_test_MC';
saveName_NIR = 'R_NIR_test_MC';
...
for i=1:N
    ...
    if add_noise == 1 % add zero-mean Gaussian noise to all reflectance values
